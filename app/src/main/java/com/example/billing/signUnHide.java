...
public class signUnHide extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sign=billing;
        billing.showMainHide(this,findViewById(R.id.first3),findViewById(R.id.first4));
        select=true;
        ...
        ((RadioGroup)findViewById(R.id.all1)).setOnCheckedChangeListener((radioGroup, i) -> {
            ...
            sign.showMainHide(signUnHide.this,findViewById(R.id.first3),findViewById(R.id.first4));
        });

        MyTitle mt=findViewById(R.id.mt2);
        mt.setText("解隐藏标签");
        mt.ChangeToSave("确定");
        mt.setOnClickListener(view -> UnHide(globe));
    }

    private void UnHide(MyApplication globe) {
        if(sign.changeType()) {
            if(select) {
            ...
            Toast.makeText(this,"解隐藏成功",Toast.LENGTH_SHORT).show();
            finish();
        } else {
